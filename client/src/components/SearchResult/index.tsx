    ...
    return ( 
        ...
        <section className={classes.container}>
            <Container maxWidth="xl">
                <Typography sx={{ margin: 2, textAlign: "center", fontSize: 20, lineHeight: 2 }} >
                    Results
                </Typography>
              <Box 
                sx={{
             ...
             {socials.map((social) => (
                ...
                <Card sx={{ borderRadius: 2,}}>
                    ...
                    <Typography sx={{ marginTop: 5, textAlign: "center", fontWeight: "bold" }} >
                    More personalized options ?  <span className={classes.span}>See suggestion</span>
                    </Typography>                   
            </Container>
        </section>
     );
